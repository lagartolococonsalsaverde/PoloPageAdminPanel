...
import { createHandicap } from "../../services/handicap";
...
const CreateHandicap = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await createHandicap(payload);
      setMessage("Handicap added successfully!");
      setFormData(initialFormState);
    } catch (err) {
      console.error(err);
      setMessage("Failed to add handicap.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-2xl mx-auto p-8 bg-white shadow-xl rounded-2xl my-10 text-left">
        ...
        <div className="grid gap-6">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? "Creating..." : "Create Handicap"}
          </button>
